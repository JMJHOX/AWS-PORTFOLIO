...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/josaparicio/Desktop/Proyectos/Foreign/AWS-PORTFOLIO/python-scripts/venv'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/josaparicio/Desktop/Proyectos/Foreign/AWS-PORTFOLIO/python-scripts/venv/bin/deactivate.nu'
